...
try:
    ...
    _payload = {'spec_id': 'pbg_membrane_actin_composite.composites.rung3_flexible_mem3dg_boundary', 'overrides': {'osmotic_force_scale': 0.02}, 'run_id': 'pbg_membrane_actin_composite.composites.rung3_flexible_mem3dg_boundary__1779244295__43639c', 'db_file': '/Users/eranagmon/code/pbg-membrane-actin-composite/studies/membrane-to-actin-displacement-feedback/runs.db', 'steps': 5, 'emit_paths': []}
