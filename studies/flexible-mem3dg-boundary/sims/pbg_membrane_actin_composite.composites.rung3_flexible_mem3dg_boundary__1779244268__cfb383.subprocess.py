...
try:
    ...
    _payload = {'spec_id': 'pbg_membrane_actin_composite.composites.rung3_flexible_mem3dg_boundary', 'overrides': {}, 'run_id': 'pbg_membrane_actin_composite.composites.rung3_flexible_mem3dg_boundary__1779244268__cfb383', 'db_file': '/Users/eranagmon/code/pbg-membrane-actin-composite/studies/flexible-mem3dg-boundary/runs.db', 'steps': 5, 'emit_paths': []}
