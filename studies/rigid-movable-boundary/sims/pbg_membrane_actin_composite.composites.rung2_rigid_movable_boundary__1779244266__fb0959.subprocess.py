...
try:
    ...
    _payload = {'spec_id': 'pbg_membrane_actin_composite.composites.rung2_rigid_movable_boundary', 'overrides': {'barrier_drag': 16.0}, 'run_id': 'pbg_membrane_actin_composite.composites.rung2_rigid_movable_boundary__1779244266__fb0959', 'db_file': '/Users/eranagmon/code/pbg-membrane-actin-composite/studies/rigid-movable-boundary/runs.db', 'steps': 5, 'emit_paths': []}
