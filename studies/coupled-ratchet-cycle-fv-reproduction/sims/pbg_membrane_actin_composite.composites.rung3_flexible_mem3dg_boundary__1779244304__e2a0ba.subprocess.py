...
try:
    ...
    _payload = {'spec_id': 'pbg_membrane_actin_composite.composites.rung3_flexible_mem3dg_boundary', 'overrides': {'growth_rate': 8.0}, 'run_id': 'pbg_membrane_actin_composite.composites.rung3_flexible_mem3dg_boundary__1779244304__e2a0ba', 'db_file': '/Users/eranagmon/code/pbg-membrane-actin-composite/studies/coupled-ratchet-cycle-fv-reproduction/runs.db', 'steps': 5, 'emit_paths': []}
