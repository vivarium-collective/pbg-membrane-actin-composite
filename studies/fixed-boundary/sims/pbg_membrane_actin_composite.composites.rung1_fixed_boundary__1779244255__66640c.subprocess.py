...
try:
    ...
    _payload = {'spec_id': 'pbg_membrane_actin_composite.composites.rung1_fixed_boundary', 'overrides': {}, 'run_id': 'pbg_membrane_actin_composite.composites.rung1_fixed_boundary__1779244255__66640c', 'db_file': '/Users/eranagmon/code/pbg-membrane-actin-composite/studies/fixed-boundary/runs.db', 'steps': 5, 'emit_paths': []}
